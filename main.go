...
func getIssuer(keyFile, certFile string, commonName string) (*issuer, error) {
...
func makeIssuer(keyFile, certFile string, commonName string) error {
...
func makeRootCert(key crypto.Signer, filename string, commonName string) (*x509.Certificate, error) {
